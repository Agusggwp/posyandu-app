...
<div class="max-w-7xl mx-auto">
    <div class="mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Laporan Pemeriksaan Lansia</h2>
        <p class="text-gray-600">Filter dan cetak laporan data lansia</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        <form method="GET" action="{{ route('laporan.lansia') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                ...
                <select name="bulan" id="bulan" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500">
            ...
            <div>
                ...
                <select name="tahun" id="tahun" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500">
            ...
            <div class="flex items-end">
                <button type="submit" class="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold py-2 px-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 w-full">
                    Filter
                </button>
            </div>

...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-lg border border-cyan-200 p-6">
        ...
        @php
            $data = $pemeriksaanRemaja->getAttributes();
        ...
        <div class="mt-6">
            <a href="{{ route('pemeriksaan-remaja.edit', $pemeriksaanRemaja->id) }}" class="bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-6 rounded-xl">Edit</a>
            <a href="{{ route('pemeriksaan-remaja.index') }}" class="ml-2 bg-cyan-700 hover:bg-cyan-800 text-white font-semibold py-2 px-6 rounded-xl">Kembali</a>
        </div>
    </div>
</div>
@endsection

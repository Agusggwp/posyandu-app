...
<div class="max-w-4xl mx-auto px-1 sm:px-0">
    <div class="mb-6">
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-800">Detail Data Balita</h2>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6">
        ...
        <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-8">
            <a href="{{ route('balita.edit', $balita) }}" class="w-full sm:w-auto text-center bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-white font-semibold py-2 px-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-200">
                Edit
            </a>

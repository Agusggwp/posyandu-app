    ...
    <div class="mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-3xl items-center justify-center">
        <div class="w-full overflow-hidden rounded-[2rem] border border-fuchsia-100 bg-white shadow-[0_25px_70px_-20px_rgba(142,70,130,0.28)]">
            <div class="px-6 py-8 text-white sm:px-10" style="background: linear-gradient(135deg, #a6599e, #8e4682);">
                ...
                <p class="mt-3 max-w-2xl text-sm text-white/85 sm:text-base">Masukkan email dan password baru untuk akun Kepala Keluarga.</p>
            </div>
            ...
            <div class="p-6 sm:p-10">
                <form method="POST" action="{{ route('kepala-keluarga.password.update') }}" class="space-y-5">
                    ...
                    <div class="flex flex-col-reverse gap-3 sm:flex-row">
                        ...
                        <button type="submit" class="inline-flex w-full items-center justify-center rounded-2xl px-4 py-3 font-bold text-white shadow-lg transition sm:w-auto" style="background: linear-gradient(135deg, #a6599e, #8e4682); box-shadow: 0 12px 30px rgba(142, 70, 130, 0.22);">Reset Password</button>
                    </div>
                </form>
            </div>
        </div>

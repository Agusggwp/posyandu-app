    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <form action="{{ route('ibu-hamil.update', $ibuHamil->id) }}" method="POST">
            ...
            <div class="mt-6">
                ...
                <textarea name="alamat" id="alamat" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('alamat') border-red-500 @enderror">{{ old('alamat', $ibuHamil->alamat) }}</textarea>

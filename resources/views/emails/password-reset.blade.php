...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif; background: #f8f9fb; margin: 0; padding: 0; color: #1f2937; line-height: 1.5;">
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #ffffff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08); overflow: hidden;">
            <!-- Header -->
            <div style="background: linear-gradient(135deg, #0ea5a4 0%, #06b6d4 100%); padding: 32px 24px; text-align: center;">
            ...
            <div style="padding: 32px 24px;">
                <p style="margin: 0 0 20px; font-size: 16px; color: #1f2937;">Halo {{ $user->name }},</p>
                ...
                <div style="margin: 32px 0; text-align: center;">
                    <a href="{{ $resetUrl }}" style="display: inline-block; background: linear-gradient(135deg, #0ea5a4 0%, #06b6d4 100%); color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 15px; box-shadow: 0 4px 12px rgba(6, 182, 212, 0.3); transition: transform 0.2s ease;">Reset Kata Sandi</a>
                </div>

                <!-- Info box -->
                <div style="background: #f0fdfa; border-left: 4px solid #0ea5a4; padding: 16px; border-radius: 4px; margin: 24px 0; font-size: 14px; color: #0f766e;">
                ...
                <p style="margin: 24px 0 0; font-size: 13px; color: #6b7280; border-top: 1px solid #e5e7eb; padding-top: 24px;">
                    ...
                    <a href="mailto:support@posyandu.local" style="color: #0ea5a4; text-decoration: none; font-weight: 500;">support@posyandu.local</a>
                </p>
            </div>
            ...
            <div style="background: #f8f9fb; padding: 20px 24px; border-top: 1px solid #e5e7eb; text-align: center; font-size: 12px; color: #6b7280;">
                ...
                <p style="margin: 0;">
                    <a href="{{ url('/') }}" style="color: #0ea5a4; text-decoration: none;">Kembali ke Sistem</a>
                </p>
            </div>
        </div>
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 0 20px;">
        <p style="margin: 0; font-size: 11px; color: #9ca3af; text-align: center;">
            Email ini dikirim karena ada permintaan reset kata sandi untuk akun Anda di Sistem Posyandu. 

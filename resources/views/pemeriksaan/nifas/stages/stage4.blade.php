                ...
                <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div class="relative">
                        <input type="text" id="search_nifas" placeholder="Ketik nama atau NIK ibu nifas..." autocomplete="off"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-600 focus:border-transparent mb-1 @error('nifas_identitas_id') border-red-500 @enderror">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_kunjungan" id="tanggal_kunjungan"
                               ...
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-600 focus:border-transparent @error('tanggal_kunjungan') border-red-500 @enderror" required>

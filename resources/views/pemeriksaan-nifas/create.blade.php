...
<div class="max-w-4xl mx-auto px-3 sm:px-4">
    <div class="mb-4 sm:mb-6">
        <h2 class="text-2xl sm:text-3xl font-bold text-rose-800">Input Pemeriksaan Nifas</h2>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg border border-rose-200 p-4 sm:p-6">
        <form action="{{ route('pemeriksaan-nifas.store') }}" method="POST">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 sm:mt-8">
                <button type="submit" class="bg-rose-700 hover:bg-rose-800 text-white font-semibold py-2 px-6 rounded-xl w-full sm:w-auto text-center">Simpan</button>

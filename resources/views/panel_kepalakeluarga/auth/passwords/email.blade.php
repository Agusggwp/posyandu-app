    ...
    <div class="mx-auto flex min-h-[calc(100vh-2rem)] w-full max-w-3xl items-center justify-center">
        <div class="w-full overflow-hidden rounded-[2rem] border border-emerald-100 bg-white/85 shadow-[0_25px_70px_-20px_rgba(5,150,105,0.35)] backdrop-blur">
            <div class="bg-gradient-to-r from-emerald-700 via-teal-700 to-cyan-700 px-6 py-8 text-white sm:px-10">
                ...
                <p class="mt-3 max-w-2xl text-sm text-emerald-50/90 sm:text-base">Masukkan email Kepala Keluarga untuk menerima tautan reset password.</p>
            </div>
            ...
            <div class="p-6 sm:p-10">
                ...
                <form method="POST" action="{{ route('kepala-keluarga.password.email') }}" class="space-y-5">
                    ...
                    <div class="flex flex-col-reverse gap-3 sm:flex-row">
                        ...
                        <button type="submit" class="inline-flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 px-4 py-3 font-bold text-white shadow-lg shadow-emerald-200 transition hover:from-emerald-700 hover:to-teal-700 sm:w-auto">Kirim Link Reset</button>
                    </div>
                </form>
            </div>
        </div>

        ...
        <form action="{{ route('ibu-hamil.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nik" id="nik" value="{{ old('nik') }}" maxlength="16" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('nik') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('tanggal_lahir') border-red-500 @enderror" required>
                ...
                <div>
                    ...
                    <input type="number" name="umur" id="umur" value="{{ old('umur') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('umur') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="nama_suami" id="nama_suami" value="{{ old('nama_suami') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('nama_suami') border-red-500 @enderror">
                    @error('nama_suami')<p class="mt-1 text-sm text-red-500">{{ $message }}</p>@enderror
                </div>

                <div>
                    <label for="no_hp" class="block text-sm font-medium text-gray-700 mb-2">No HP</label>
                    <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('no_hp') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="l_ibu_hamil" id="l_ibu_hamil" value="{{ old('l_ibu_hamil') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('l_ibu_hamil') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="number" name="kehamilan_ke" id="kehamilan_ke" value="{{ old('kehamilan_ke') }}" min="1" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('kehamilan_ke') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="jarak_anak_sebelumnya" id="jarak_anak_sebelumnya" value="{{ old('jarak_anak_sebelumnya') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('jarak_anak_sebelumnya') border-red-500 @enderror">

            ...
            @else
                <div class="mb-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <input type="text" id="search_lansia" placeholder="Ketik nama atau NIK lansia..." 
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent mb-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <select name="dewasa_identitas_id" id="dewasa_identitas_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('dewasa_identitas_id') border-red-500 @enderror" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="waktu_kunjungan" id="waktu_kunjungan" value="{{ old('waktu_kunjungan', $data['waktu_kunjungan'] ?? now()->format('Y-m-d')) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('waktu_kunjungan') border-red-500 @enderror" required>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const selectDropdown = document.getElementById('lansia_identitas_id');

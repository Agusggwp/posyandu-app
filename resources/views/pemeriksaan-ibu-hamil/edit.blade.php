                ...
                <div>
                    ...
                    <select name="ibu_hamil_id" id="ibu_hamil_id" 
                        ...
                        @foreach($ibuHamils as $ibuHamil)
                            <option value="{{ $ibuHamil->id }}" {{ old('ibu_hamil_id', $pemeriksaan->ibu_hamil_id) == $ibuHamil->id ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <div>
                    ...
                    <input type="text" name="lingkar_lengan_atas" id="lingkar_lengan_atas" 
                           value="{{ old('lingkar_lengan_atas', $pemeriksaan->lingkar_lengan_atas) }}"
                ...
                <div>
                    ...
                    <input type="text" name="tinggi_fundus" id="tinggi_fundus" 
                           value="{{ old('tinggi_fundus', $pemeriksaan->tinggi_fundus) }}"
                ...
                <div>
                    ...
                    <input type="text" name="denyut_jantung_janin" id="denyut_jantung_janin" 
                           value="{{ old('denyut_jantung_janin', $pemeriksaan->denyut_jantung_janin) }}"

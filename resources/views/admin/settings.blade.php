...
<div class="max-w-4xl mx-auto px-3 sm:px-4">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-4 sm:p-8 border border-indigo-100">
        <div class="text-center py-12">
            ...
            <div class="mt-6">
                <a href="{{ route('admin.dashboard') }}" class="inline-block w-full sm:w-auto bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white font-semibold py-2 px-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-200">

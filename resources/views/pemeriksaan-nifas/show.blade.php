...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-lg border border-rose-200 p-6">
        ...
        <div class="mt-6">
            <a href="{{ route('pemeriksaan-nifas.edit', $pemeriksaanNifas->id) }}" class="bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-6 rounded-xl">Edit</a>
            <a href="{{ route('pemeriksaan-nifas.index') }}" class="ml-2 bg-rose-700 hover:bg-rose-800 text-white font-semibold py-2 px-6 rounded-xl">Kembali</a>
        </div>
    </div>
</div>
@endsection

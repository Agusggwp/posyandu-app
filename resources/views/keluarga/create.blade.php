...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Tambah Data Keluarga</h2>
        ...
        <form action="{{ route('keluarga.store') }}" method="POST">
            ...
            <div class="mt-6">
                ...
                <textarea name="alamat" id="alamat" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('alamat') border-red-500 @enderror" required>{{ old('alamat') }}</textarea>
                @error('alamat')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
                <div>
                    ...
                    <input type="text" name="rt" id="rt" value="{{ old('rt') }}" maxlength="3"
                ...
                <div>
                    ...
                    <input type="text" name="rw" id="rw" value="{{ old('rw') }}" maxlength="3"
            ...
            <div class="mt-6">
                ...
                <input type="text" name="telepon" id="telepon" value="{{ old('telepon') }}" maxlength="15"

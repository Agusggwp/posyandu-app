...
<div class="max-w-4xl mx-auto px-1 sm:px-0">
    <div class="bg-white rounded-lg shadow-lg border border-cyan-200 p-4 sm:p-6">
        <h2 class="text-xl sm:text-2xl font-bold text-cyan-900 mb-6">Detail Remaja</h2>
        ...
        <div class="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <a href="{{ route('remaja.edit', $remaja) }}" class="w-full sm:w-auto text-center bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-6 rounded-xl">Edit</a>
            <a href="{{ route('remaja.index') }}" class="w-full sm:w-auto text-center bg-cyan-700 hover:bg-cyan-800 text-white font-semibold py-2 px-6 rounded-xl sm:ml-0">Kembali</a>
        </div>
    </div>
</div>
@endsection

                ...
                <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <div class="relative">
                        <input type="text" id="search_balita" placeholder="Ketik nama atau NIK balita..." autocomplete="off"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent mb-1 @error('balita_identitas_id') border-red-500 @enderror">

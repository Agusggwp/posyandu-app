        ...
        <form action="{{ route('lansia.store') }}" method="POST">
            ...
            <div class="mt-6">
                ...
                <textarea name="riwayat_penyakit" id="riwayat_penyakit" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent @error('riwayat_penyakit') border-red-500 @enderror">{{ old('riwayat_penyakit') }}</textarea>

...
<div class="max-w-5xl mx-auto px-3 sm:px-4">
    <div class="mb-4 sm:mb-6">
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-800">Pemeriksaan Nifas - Sistem 4 Tahap</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="p-6 bg-gradient-to-r from-violet-50 to-purple-50">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Berat badan, tinggi badan, LILA, status gizi</p>
                    </div>
                </div>
            </div>
            <div class="p-6">
                <a href="{{ route('pemeriksaan-nifas.stage', 1) }}" class="block w-full text-center bg-violet-600 hover:bg-violet-700 text-white font-semibold py-3 rounded-xl transition">
                    Mulai Tahap 1
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden border-t-4 border-blue-500">
            ...
            <div class="p-6">
                <a href="{{ route('pemeriksaan-nifas.stage', 2) }}" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-xl transition">
                    Mulai Tahap 2
                </a>
            </div>
        </div>
            ...
            <div class="p-6 bg-gradient-to-r from-emerald-50 to-green-50">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Vitamin A, menyusui, jenis KB pasca salin</p>
                    </div>
                </div>
            </div>
            <div class="p-6">
                <a href="{{ route('pemeriksaan-nifas.stage', 3) }}" class="block w-full text-center bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3 rounded-xl transition">
                    Mulai Tahap 3
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden border-t-4 border-orange-500">
            ...
            <div class="p-6">
                <a href="{{ route('pemeriksaan-nifas.stage', 4) }}" class="block w-full text-center bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 rounded-xl transition">
                    Mulai Tahap 4
                </a>
            </div>
        </div>
    ...
    <div class="mt-8 bg-white rounded-lg shadow-lg p-6">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-gray-800">
                <i class="fas fa-clipboard-list text-rose-600 mr-2"></i>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Ibu Nifas</th>
                        ...
                        @foreach($pemeriksaanBelumSelesai as $item)
                            ...
                            <tr>
                                <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">
                                    {{ $item->nifas->nama_ibu ?? $item->nifas_identitas_id }}
                                </td>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm">
                                    <a href="{{ route('pemeriksaan-nifas.stage', ['stage' => $nextStage, 'pemeriksaan_id' => $item->id]) }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-rose-600 hover:bg-rose-700 text-white font-medium">
                                        Lanjutkan
                                    </a>
                                </td>
                            </tr>
    ...
    <div class="mt-8">
        <a href="{{ route('pemeriksaan-nifas.index') }}" class="inline-flex items-center gap-2 text-rose-600 hover:text-rose-700 font-medium">

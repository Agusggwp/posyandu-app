...
<div class="max-w-7xl mx-auto px-1 sm:px-0">
    ...
    <div class="mb-6">
        <div class="relative">
            ...
            <input type="text" id="searchInput" placeholder="Cari berdasarkan nama, NIK, atau keluarga..." class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-violet-500 focus:border-transparent">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    searchInput.addEventListener('input', async function () {
        ...
        try {
            const response = await fetch(`{{ route('api.search.ibu-hamil') }}?q=${encodeURIComponent(query)}`);
            ...
            searchResults.innerHTML = results.map(item => `
                <a href="{{ url('ibu-hamil') }}/${item.id}" class="block px-4 py-2 hover:bg-gray-100 border-b border-gray-200 last:border-b-0 cursor-pointer">

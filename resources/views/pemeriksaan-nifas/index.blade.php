...
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-8">
        <div>
            <h2 class="text-4xl font-bold bg-gradient-to-r from-rose-700 to-pink-800 bg-clip-text text-transparent">Pemeriksaan Nifas</h2>
            <p class="text-slate-600 mt-2">Riwayat pemeriksaan nifas</p>
        </div>
        <a href="{{ route('pemeriksaan-nifas.create') }}" class="bg-gradient-to-r from-rose-700 to-pink-800 hover:from-rose-800 hover:to-pink-900 text-white font-semibold py-2 px-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-200">+ Tambah Pemeriksaan</a>
    </div>

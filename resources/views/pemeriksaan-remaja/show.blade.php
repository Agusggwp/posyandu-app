...
<div class="max-w-4xl mx-auto px-3 sm:px-4">
    <div class="bg-white rounded-lg shadow-lg border border-cyan-200 p-4 sm:p-6">
        ...
        <div class="mt-6 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <a href="{{ route('pemeriksaan-remaja.edit', $pemeriksaanRemaja->id) }}" class="bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-6 rounded-xl w-full sm:w-auto text-center">Edit</a>

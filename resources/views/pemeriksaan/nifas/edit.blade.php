        ...
        <form action="{{ route('pemeriksaan-nifas.update', $pemeriksaanNifas->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_kunjungan" value="{{ old('tanggal_kunjungan', $pemeriksaanNifas->tanggal_kunjungan ? \Illuminate\Support\Carbon::parse($pemeriksaanNifas->tanggal_kunjungan)->format('Y-m-d') : '') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                </div>
                <div>

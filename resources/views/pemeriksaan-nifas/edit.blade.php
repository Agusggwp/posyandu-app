...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h2 class="text-3xl font-bold text-rose-800">Edit Pemeriksaan Nifas</h2>
    </div>
        ...
        <form action="{{ route('pemeriksaan-nifas.update', $pemeriksaanNifas->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="waktu_kunjungan" value="{{ old('waktu_kunjungan', $pemeriksaanNifas->waktu_kunjungan ? \Illuminate\Support\Carbon::parse($pemeriksaanNifas->waktu_kunjungan)->format('Y-m-d\\TH:i') : '') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg">
                </div>
                <div>
